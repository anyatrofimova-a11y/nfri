...
`python3 harness/style_check.py` (all sections should pass). This skill is the working summary.
...
- Close on a turn or reframe the reader could not have started with.
...
- Do not name external authors, firms, or indices anywhere that renders to the site.

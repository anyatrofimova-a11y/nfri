...
def main():
    ...
    order = ("argument", "analysis", "product", "findings", "methodology", "data")
    ...
    html = html.replace("<!--__PRODUCT__-->", essays["product"])
...
<header class="top"><div class="wrap">
  ...
  <nav>
    <a href="#argument">Abstract</a><a href="#analysis">Analysis</a><a href="#product">Product</a><a href="#index">Index</a><a href="#table">Entities</a>
...
<div class="wrap">
  ...
  <section id="product" class="essay"><div class="col"><!--__PRODUCT__--></div></section>
